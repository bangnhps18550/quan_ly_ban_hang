...
Thread dongho;
    ...
    public gaiodien_xanhla(String CurrentUser) {
        initComponents();
        lblHoaDon.setHorizontalTextPosition((int) CENTER_ALIGNMENT);
        lblHoaDon.setVerticalTextPosition(JLabel.BOTTOM);
        lblThongKe.setHorizontalTextPosition((int) CENTER_ALIGNMENT);
        lblThongKe.setVerticalTextPosition(JLabel.BOTTOM);
        lblDangXuat.setHorizontalTextPosition((int) CENTER_ALIGNMENT);
        lblDangXuat.setVerticalTextPosition(JLabel.BOTTOM);
        lblHoaDon.setHorizontalTextPosition((int) CENTER_ALIGNMENT);
        lblHoaDon.setVerticalTextPosition(JLabel.BOTTOM);
        lblHoaDon.setHorizontalAlignment(JLabel.CENTER);
        lblQuanLy.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img_GiaoDienChinh/google_ads_125px.png"))); // NOI18N
